...
function createEmail(emails) {
   for(let i=0; i<50; i++){
     ...
     <div class="importantHover">
       ...
       <section class="subject">${emails[i].messageTitle}<span class="emailContent"> - ${emails[i].messages[0].message}</span></section> 
       </div>
       <div class = 'two'>
     ...
     const eachEmailLine = document.querySelectorAll(".email")
